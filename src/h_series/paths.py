...
H0_FINDINGS_MD = ROOT / "H0_FINDINGS.md"
H0_FINDINGS_JSON = ROOT / "H0_FINDINGS.json"
H1_FINDINGS_MD = ROOT / "H1_FINDINGS.md"
H1_FINDINGS_JSON = ROOT / "H1_FINDINGS.json"
H2_FINDINGS_MD = ROOT / "H2_FINDINGS.md"
H2_FINDINGS_JSON = ROOT / "H2_FINDINGS.json"
