...
FAST = [
    ...
    "tests/portfolio/test_terminal_events.py",
    ...
    "tests/data_collection/test_prices_negative_cache.py",
    "tests/data_collection/test_prices_collect_dividends.py",
    "tests/data_collection/test_refresh_tail_only.py",
    ...
    "tests/data_collection/test_sec_company_info.py",
    "tests/data_collection/test_sec_companyfacts.py",
    "tests/data_collection/test_sec_cover_page.py",
    "tests/data_collection/test_sec_fds.py",
    "tests/data_collection/test_sec_selected_financial_data.py",
    "tests/data_collection/test_sec_tenq.py",
    "tests/data_collection/test_sec_fundamentals.py",
    "tests/data_collection/test_pipeline_dispatch.py",
    "tests/data_collection/test_universe_derivation.py",
    ...
    "tests/data_collection/test_cvm_crosswalk.py",
    "tests/data_collection/test_company_info.py",
    "tests/data_collection/test_validate_price_jump.py",
    "tests/data_collection/test_sec_unit_currency.py",
]
...
DATA = [
    ...
    "tests/build_dataset/test_instrument_basis.py",
    "tests/build_dataset/test_panel_integrity.py",
    ...
    "tests/build_dataset/test_manifest_drift.py",
    ...
    "tests/data_collection/test_universe_coverage.py",
